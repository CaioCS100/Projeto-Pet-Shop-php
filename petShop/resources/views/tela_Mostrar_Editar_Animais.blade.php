@extends('template.templateMenuBar')
    ...
    <form method="POST" action=" {{ route('atualizarAnimal',['id' => $animal->id]) }} " enctype="multipart/form-data">
        {{ csrf_field() }}
        <fieldset>
                ...
                <div id="espaco">
                    ...
                    @if($errors->any())
                        <div class="alert alert-danger temporario" role="alert">
                            <strong>Erro ao alterar animal!</strong>
                    ...
                    @endif
                        <div class="form-row">
                            <div class="form-group col-md-10">
                                ...
                                <input type="text" class="form-control" id="idNomeDono" name="nomeDono" placeholder="Clique no botão ao lado para encontrar o cliente desejado" value="{{old('nomeDono', $animal->nome)}}" readonly>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="idNomeAnimal" name="nomeAnimal" placeholder="Digite seu nome completo" value="{{old('nomeAnimal',$animal->nome_pet)}}" disabled>
                            </div>
                            
                            <div class="form-group col-md-2" id="radioButton">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sexo" id="idMacho" value="M" @if($animal->sexo == 'M') {{"checked=\'checked\'"}}@endif disabled>
                                    <label class="form-check-label" for="idMacho">Macho</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sexo" id="idFemea" value="F" @if($animal->sexo == 'F') {{"checked=\'checked\'"}}@endif disabled>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="date" class="form-control" id="idData" name="data" value="{{old('data',$animal->data_de_nascimento_pet)}}" disabled>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="idPeso">Peso<span class="asterisco">*</span>:</label>
                                <input type="number" class="form-control" id="idPeso" name="peso" value="{{old('peso',$animal->peso)}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control" id="idEspecie" name="especie" value="{{old('especie',$animal->nome_especie)}}" readonly>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="idCor" name="cor" value="{{old('cor',$animal->cor)}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <textarea id="idObs" name="obs" rows="5" cols="95" disabled>{{old('obs',$animal->observacao_sobre_pet)}} </textarea> <br/>
                            </div>
                            <div id="mostrarImagem" class="form-group col-md-4">
                                    <div id="image-holder"style="color: #B0C4DE">{{old('',$animal->nome_da_imagem)}}</div>
